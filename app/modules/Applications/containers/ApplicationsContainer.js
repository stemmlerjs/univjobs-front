...
import * as applicationActionCreators from 'redux/modules/applicants/applicants'
 ...
 */
  ...
  render () {
    return (
      ...
      <SidebarContainer isMobile={this.props.isMobile} isAStudent={this.props.user.isAStudent} page={this.props.route.page}/>
       <Applications
