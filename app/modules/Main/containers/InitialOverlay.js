...
//    debugger
  ...
  componentDidMount() {
    ...
    */
    ...
    if (window.isMobile && this.shouldRenderMobileSidebar()) {
   ...
   * detectMobile
   *
   * Detect if the device is Android or IOS mobile.
   * We look for the Mobile object.
   * 
   */

  detectMobile() {
    
    if (/Mobi/i.test(navigator.userAgent) || /Anroid/i.test(navigator.userAgent) || /Mobile/i.test(navigator.userAgent)) {
   ...
   * handleToggleMenu
   * 
   * Simply opens the Slideout.js Left side navigation
   * for mobile view.
   */
  ...
  /*
   * handleCloseMenuOnRouteChange
   * 
   * Closes the Slideout.js menu when we change routes.
   */
   ...
   * 
   * This function is used to decide whether or not we should render MobileSlider
   * 
   */
  ...
  shouldRenderMobileSidebar () {
    ...
    publicPages.forEach((page) => {
      if (this.props.page.indexOf(page) !== -1) {
        render = false
      }
    })
  ...
  render () {
    ...
    /*
     * Supply all child props with some additional attributes
     * generated from this root component.
     * 
     * closeOverlay [func] - to close the overlay after page load 
     * isMobile [bool]     - to know if the site should be mobile viewed
     */
    ...
    return (
      <div style={styles.main}>
         ...
         * 
         * This is a really important piece of code.
         * Right here, we decide which view to show. 
         * 
         * Either we render the Mobile View or the Desktop 
         * App view.
         * 
...

        {
          this.detectMobile() && this.shouldRenderMobileSidebar()
            ? <MobileSlider
                ...
                closeMenuOnRouteChange={this.handleCloseMenuOnRouteChange}
