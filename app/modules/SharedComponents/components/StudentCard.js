...
cardContainer__contacted, hidden, altImageContainer, grayButton } from '../styles/StudentCard.css'
...

              {
                resumeUrl.indexOf('null') === -1
                  ? <button><a className={whiteTxt} target="_blank" href={resumeUrl}>RESUME</a></button>
                      :   <div>
                            <button data-tip data-for='noResume' className={grayButton}>RESUME</button>
                            <ReactTooltip id='noResume' delayHide={100} delayShow={100} place="bottom" effect="float">
                                <span>Student has no resume</span>
                            </ReactTooltip>
                        </div>
                  }
