...
// ================CSS IMPORTS============================== //
import { nav, logoText, noDeco, btn,  navItem,
        btnBlue, pseudoBtn, loginIcon, univjobsLogo, navContainer, btnBabyBlue} from '../styles/NavigationStyles.css'
...
const RegularNav = () => (
        <div className={`${nav} ${navContainer}`}>
                ...
                <div className={nav}>
                    ...
                    <Link to="/join" className={ `${pseudoBtn} ${btnBabyBlue} ${navItem} ${material_1}` }>
                        LOGIN
                    </Link>
