...
export default function JobCard({ jobs, jobTypes, industries, children}) {
      ...
      <div className={cardContainer}>
	   ...
	   {/*JOB TYPES*/}
	    ...
	    <div className={jobTitleContainer}>
	       <h2 className={jobTitle}>{jobs ? jobs.title : ''}</h2>
	    </div>
		...
		<li className={tagElement}>
	      ...
	      <div>
		   ...
		   <li>
			...
			<li>
			  <h4 className={companyTitle}>{ jobs ? jobs.business.company_name : ''}</h4>
		        </li>
		
			<li>
			  <a href={ jobs ? jobs.business.website : ''} target="_blank">Company Info</a>
		        </li>
		     </ul> 
		    </li>
		 </ul>
