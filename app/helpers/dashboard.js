...
import { fetchingJobs, fetchedJobSuccess, fetchedJobErrors, getStudentsSuccess, getStudentsError } from 'redux/modules/dashboard/dashboard'
...
export function getJobs(store) {
 const promise = new Promise((resolve, reject) => {
   ...
   .catch((err) => {
     store.dispatch(fetchedJobErrors('Error occured while retrieving jobs'))
      console.log(err)
      resolve(false)
   })//catch
 })//promise
